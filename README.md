...
3. Open *enviroments* tab and create new enviroment.<img 
    style="display: block; 
           margin-left: auto;
           margin-right: auto;
           width: 66%;"
...
4. Name it, e.t. *For_EOA*. Change Python version, if necessary.<img 
    style="display: block; 
           margin-left: auto;
           margin-right: auto;
           width: 66%;"
...
5. Install VS Code from home panel or [download it](https://code.visualstudio.com).<img
    style="display: block; 
           margin-left: auto;
           margin-right: auto;
           width: 66%;"
