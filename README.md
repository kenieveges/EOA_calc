...
$\Delta P_{mean}$ was calculated with data from source 1. In `Python` realisation of the integral is basically Rimman's sum, since $dt \rightarrow 0$ and  $\Summ\equiv$ $\Delta P_{mean}$. Mentioned goes in two steps:
